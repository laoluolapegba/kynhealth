...
var setItemToStore = function setItemToStore(key, payload) {
  var store = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : localStorage;
  return store.setItem(key, JSON.stringify(payload));
};
...
var redirectToDocs = function redirectToDocs(id) {
  ...
  input && input.addEventListener('change', function (e) {
    ...
    isChecked ? location.replace(getData(el, 'pageUrl')) : location.replace(getData(el, 'homeUrl'));
  });
};
...
var scrollToTop = function scrollToTop() {
  document.querySelectorAll('[data-anchor] > a, [data-scroll-to]').forEach(function (anchor) {
    anchor.addEventListener('click', function (e) {
      ...
      window.scroll({
        top: (_utils$getData2 = utils.getData(el, 'offset')) !== null && _utils$getData2 !== void 0 ? _utils$getData2 : utils.getOffset(document.querySelector(id)).top - 100,
        left: 0,
        behavior: 'smooth'
      });
