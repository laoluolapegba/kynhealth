    ...
    public partial class customproperties : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_roles", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_logins", x => new { x.LoginProvider, x.ProviderKey });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_user_claims", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_users", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_usertokens", x => new { x.UserId, x.LoginProvider, x.Name });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_roleclaims", x => x.Id);
                    table.ForeignKey(
                        name: "FK_kyn_roleclaims_kyn_roles_RoleId",
                        column: x => x.RoleId,
                        principalSchema: "public",
                        principalTable: "kyn_roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kyn_user_roles", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_kyn_user_roles_kyn_roles_RoleId",
                        column: x => x.RoleId,
                        principalSchema: "public",
                        principalTable: "kyn_roles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_kyn_logins_UserId",
                schema: "public",
                table: "kyn_logins",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_kyn_roleclaims_RoleId",
                schema: "public",
                table: "kyn_roleclaims",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_kyn_user_claims_UserId",
                schema: "public",
                table: "kyn_user_claims",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_kyn_user_roles_RoleId",
                schema: "public",
